...
-- DATA DICTIONARY IS READ-ONLY
-- CONSISTS OF BASE TABLES AND USER-ACCESSIBLE VIEWS
-- ORACLE USER SYS OWNS ALL BASE TABLES AND USER-ACCESSIBLE VIEWS OF THE DATA
-- DICTIONARY
...
-- TABLE IS ALWAYS VALID, BUT VIEW CAN SOMETIMES BECOME INVALID

SELECT * FROM ALL_OBJECTS
WHERE OBJECT_NAME = 'EMPLOYEES';

-- CAT IS THE USER_CATALOG
-- CAT IS A DICTIONARY CONTAINING ONLY TABLE_NAME AND TABLE_TYPE
...
-- SEARCH CONDITION ONLY PRESENT FOR CHECK TYPE CONSTRAINTS
...
SELECT M.OWNER, M.TABLE_NAME, M.CONSTRAINT_NAME, D.TABLE_NAME
FROM USER_CONSTRAINTS M LEFT OUTER JOIN
USER_CONSTRAINTS D
ON (M.R_CONSTRAINT_NAME = D.CONSTRAINT_NAME)
WHERE M.TABLE_NAME = 'EMPLOYEES';
